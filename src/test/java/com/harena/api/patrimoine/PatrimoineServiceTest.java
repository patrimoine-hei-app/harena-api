...
public class PatrimoineServiceTest {
  ...
  @Mock private PatrimoineRepository patrimoineRepository;

  @InjectMocks private PatrimoineService patrimoineService;
  ...
  public void setUp() {
    ...
    possessions1.add(
        new Materiel(
            "Materiel 1", LocalDate.of(2024, 7, 26), 5000, LocalDate.of(2023, 7, 26), 0.05));

    Set<Possession> possessions2 = new HashSet<>();
    possessions2.add(new Argent("Argent 2", LocalDate.of(2024, 7, 26), 20000));
    possessions2.add(
        new Materiel(
            "Materiel 2", LocalDate.of(2024, 7, 26), 10000, LocalDate.of(2023, 7, 26), 0.05));

    // Create patrimoines
    patrimoine1 =
        new Patrimoine(
            "Patrimoine1", new Personne("Fifa"), LocalDate.of(2024, 7, 26), possessions1);
    patrimoine2 =
        new Patrimoine(
            "Patrimoine2", new Personne("Maharavo"), LocalDate.of(2024, 7, 26), possessions2);
  }
  ...
  public void get_all_patrimoine_test() {
    ...
    when(patrimoineRepository.getAllPaginatedPatrimoines(anyInt(), anyInt()))
        .thenReturn(mockPatrimoines);
